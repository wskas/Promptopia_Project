...
const PromptCard = ( { post, handleTagClick, handleEdit, handleDelete }) => {
  ...
  return (
    <div className='prompt_card'>
      <div className='flex justify-between items-starts gap-5'>
      ...
      {session?.user.id === post.creator._id && pathName === '/profile' && (
        <div className='mt-5 flex-center gap-4 border-t border-gray-100 pt-3'>
          <p className='font-inter textsm green_gradient cursor-pointer' onClick={handleEdit}>
            Edit
          </p>
          <p className='font-inter textsm orange_gradient cursor-pointer' onClick={handleDelete}>
            Delete
          </p>
        </div>
      )}
